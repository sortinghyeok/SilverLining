...
export default function Home({navigation}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style = {{marginLeft : '10%'}}>당신의 자립을 돕습니다.</Text>

      <View style = {{marginTop : 15, alignItems : 'center'}}>
        <View style = {{flexDirection : 'row'}}>
        <TouchableOpacity>
          <View style = {styles.gridBox}>
            <Text style = {{fontSize : 20}}>구인구직</Text>
            <Text style = {{fontSize : 20}}>플랫폼</Text>
            <Entypo name="briefcase" size={45} color="black" style = {styles.iconPos}/>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style = {styles.gridBox}>
            <Text style = {{fontSize : 20}}>주변 병원 &</Text>
            <Text style = {{fontSize : 20}}>복지시설 찾기</Text>
        ...
        <TouchableOpacity>
          <View style = {styles.gridBox}>
            <Text style = {{fontSize : 20}}>맞춤형 정책 &</Text>
            <Text style = {{fontSize : 20}}>지원사업</Text>
            <Text style = {{fontSize : 20}}>알리미 서비스</Text>
            <MaterialIcons name="policy" size={45} color="black" style = {styles.iconPos}/>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style = {styles.gridBox}>
          <Text style = {{fontSize : 20}}>주변 친구와</Text>
          <Text style = {{fontSize : 20}}>알림 주고 받기</Text>
