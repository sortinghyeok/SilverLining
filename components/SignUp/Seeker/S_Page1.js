...
export default function S_Page1({navigation}) {
  ...
  return (
    <View style = {styles.container}>
      ...
      <View style = {{left : '10%'}}>
      <Text style  = {{fontSize : 20, marginBottom : 10, fontFamily : 'IBMMe'}}>6단계 - 일반이용자 정보입력</Text>
    ...
    <View style = {{alignSelf : 'center', height : WidthAndHeight.windowHeight*0.3, marginTop : 15}}>
    <SafeAreaView>
